...
> **[v1.0.1-dev.1](https://github.com/Educal72/educal-patches/releases/tag/v1.0.1-dev.1)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;1 patches total
<details open>
...
<!--
  ...
  and injects the real patch list here after your first release. Leave a
